...
def test2(gp, edge):
    ...
    return {
        ...
        "E2b_feynman": {"primary": B, "extension": e2b(ext),
                        ...
                        "note": "one vortex in the central disk changes the ratio by ~0.05-0.12 (8-18 central vortices); the Omega=0.8 step-cap value 0.841 becomes 0.925 in the extension run"},
    ...
    rep = {
        ...
        "local_file_domain06": {
            ...
            "evidence": [
                ...
                "the NIMS SuperCon database is a database of superconducting materials and critical temperatures, not of vortex images or coordinates; YBCO SQUID images are not distributed as dimensionless 20x15 coordinate lists (statement from general knowledge of the database, not checked online in this run)"],
