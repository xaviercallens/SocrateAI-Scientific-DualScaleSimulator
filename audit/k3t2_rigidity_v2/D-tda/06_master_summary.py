...
summary = {
    ...
    "rigidity_scan_over_k": {
        ...
        "manifoldness_condition_classification": s5["N=6"]["candidate_structural_condition_manifoldness"]["classification"],
        "parity_condition_classification": s5["N=6"]["structural_but_weak_condition_parity"]["classification"],
        "parity_solution_set_size": s5["N=6"]["structural_but_weak_condition_parity"]["set_size"],
