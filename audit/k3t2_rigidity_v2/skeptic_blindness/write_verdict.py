...
V = {
 ...
 "forbidden_path_scan": {
  ...
  "result": "CLEAN. The only hits are prose disclaimers (D-tda/06_master_summary.py:28-32) and docstrings naming the licensed v1 code dirs (A-genus/run_track_a_v2.py:7, C-lattices/01_e8.py:7, 02_k3_mukai_gamma.py:5). No script opens a LeanMaster, sealed-v2, proofs/, lean_foundation/, PAPER_FACTS or v1 sealed-comparison file. Cross-track reads are only: C reads D-tda/exports.json and A-genus/exports.json; chain reads each track's own outputs."
 },
 "literal_scan": {
